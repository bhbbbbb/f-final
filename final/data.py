...
DATASET_URL = 'https://www.dropbox.com/scl/fi/ejkje0mv5wfcaanpgtzui/datasets_20240520.zip?rlkey=muu7ycdkbqyaxlcgfl6psomqe&st=qw5a4p94&dl=0'
_DATASET_URL_HASH = hashlib.md5(DATASET_URL.encode()).hexdigest()
...
def load_df(cache_dir: str = CACHE_DIR) -> pd.DataFrame:
